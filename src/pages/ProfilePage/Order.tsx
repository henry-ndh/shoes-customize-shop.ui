...
import { useGetOrderConfirm } from '@/queries/cart.query';
export default function Order() {
  const { data: orderConfirm } = useGetOrderConfirm();
  const listOrderConfirm = orderConfirm?.listObjects;
    ...
    <Tabs defaultValue="password" className="w-full">
      ...
      <TabsContent value="password">
        ...
        <div className=" flex flex-col gap-4">
          {listOrderConfirm?.map((orderConfirm) => (
